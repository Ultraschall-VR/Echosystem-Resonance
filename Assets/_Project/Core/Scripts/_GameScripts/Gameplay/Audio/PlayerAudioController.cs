...
namespace Echosystem.Resonance.Audio
{
    ...
    {
        [Header("Uncovering")] [Header("MECHANICS")]
        public AudioAsset UncoveringLoop;

        public AudioAsset UncoveringStart;
        public AudioAsset UncoveringRelease;

        [Header("Teleport")] public AudioAsset TeleportRelease;

        [Header("Gravity pull")] public AudioAsset GravityPullSnapping;
        public AudioAsset GravityPullLoop;

        [Header("Sling Shot")] public AudioAsset SlingShotLoop;
    }
